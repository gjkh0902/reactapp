...
class App extends Component {
	state = {
		cardList: [
			...
			{
				img: "https://p1.music.126.net/xH2YgphAmpm3MIM2ASwTMg==/109951163104636838.jpg?" + "param=400y400",
				avatar: "https://zos.alipayobjects.com/rmsportal/ODTLcjxAfvqbxHnVXCYX.png",
				title: "These Days",
			...
			{
				img: "http://p1.music.126.net/WlbH-A4FdnB6joqQlxAAwg==/109951163213837979.jpg?" + "param=400y400",
				avatar: "https://zos.alipayobjects.com/rmsportal/ODTLcjxAfvqbxHnVXCYX.png",
			...
			{
				img: "http://p1.music.126.net/1gwOMiu3ua63rxtCYUFa_g==/109951163159246435.jpg?" + "param=400y400",
				avatar: "https://zos.alipayobjects.com/rmsportal/ODTLcjxAfvqbxHnVXCYX.png",
				title: "Lullaby Days",
			...
			{
				img: "http://p1.music.126.net/dvk8oNANHr3QO1EGLXeNTA==/18654314278872125.jpg?" + "param=400y400",
				avatar: "https://zos.alipayobjects.com/rmsportal/ODTLcjxAfvqbxHnVXCYX.png",
				title: "Meant to Be",
					...
					{cardList.map((item, index) => (
						<Col span={8} key={item.key}>
							<Card
								...
								<Meta avatar={<Avatar src={item.avatar} />} title={item.title} description={item.description} />
							</Card>
						</Col>
					))}
				</Row>
